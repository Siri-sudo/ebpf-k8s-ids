...
def parse_arguments():
    ...
    parser.add_argument('--output-file', type=str, default='scan_snort_resources.json', help='Output file for resource utilization')
...
def main():
    ...
    # Start a thread to record resource utilization
    monitoring_thread = threading.Thread(target=record_resource_utilization, args=(interval, utilization_data, end_time))
