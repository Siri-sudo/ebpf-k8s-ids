...
def parse_arguments():
    ...
    parser.add_argument('--output-file', type=str, default='ebpf_detection_times.json', help='Output file for detection times')
...
def monitor_logs(container_name, start_time_ns, detection_queue):
    ...
    log_pattern = re.compile(r"Port scan detected from IP:")  # Adjusted to match 'Port scan detected from IP: 201f40a'
